; Projeto de sem�foro com Arduino utilizando chaveamento de LEDs.
;
; Created: 26/06/2022
; Author : Itallo Patrick
; Author : Jeferson Fernando
; Author : Jo�o Victor Holanda
...
OCI2A_Interrupt:
	...
	// Verifica se o sem�foro a ser exibido � o primeiro.
	...
	adc ZH, temp // Se a opera��o em ZL der overflow, adiciona o carry em ZH

	lpm current_leds, Z // Carrega os bits dos leds do sem�foro
	...
	// Verifica se o sem�foro a ser exibido � o segundo.
	verify_second_semaphore:
		...
		rjmp skip_semaphore_verify
	// Verifica se o sem�foro a ser exibido � o terceiro.
	...
	// Verifica se o sem�foro a ser exibido � o quarto.
	verify_fourth_semaphore:
		...
		rjmp skip_semaphore_verify
		// Verifica se o sem�foro a ser exibido � o de pedestres.
	...
	skip_semaphore_verify:
		...
		inc current_showing // Atualiza o sem�foro atual
		cpi current_showing, MAX_SEMAPHORE // Verifica se passou do �ltimo sem�foro
		brne skip_current_showing_zero // Se n�o passar do �ltimo, vai para a label skip_current_showing_zero

		ldi current_showing, 0 // Se passou do �ltimo, volta para o primeiro

	skip_current_showing_zero:
		// In�cio da cor vermelha
		// Atualiza estado do led vermelho.
		mov temp, current_leds
		andi temp, 1 << RED_LED_BIT // Filtra o valor do bit do led vermelho
		tst temp // verifica se o valor do bit do led vermelho � igual a 0
		brne red_led_on // se n�o for igual a 0, ele � 1 e precisa ser ligado

		in temp, RED_LED_PORT
		andi temp, ~(1 << RED_LED_PIN) 
		out RED_LED_PORT, temp

		rjmp red_led_end // vai para a outra cor do sem�foro
	
	red_led_on:
		in temp, RED_LED_PORT // L� os bits da porta usada
		ori temp, 1 << RED_LED_PIN // Seta 1 no bit espec�fico referente ao pino do led
		out RED_LED_PORT, temp // Salva os bits

	red_led_end:
		// In�cio do cor amarela
		// Atualiza estado do led amarelo.
		mov temp, current_leds
		andi temp, 1 << YELLOW_LED_BIT // Filtra o valor do bit do led amarelo
		tst temp // verifica se o valor do bit do led amarelo � igual a 0
		brne yellow_led_on // se n�o for igual a 0, ele � 1 e precisa ser ligado
